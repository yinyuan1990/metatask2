	...
	<div class="banner-outer-container">
		<div class="banner-container" ref="scrollContainer">
			<div v-for="(item, index) in banners" :key="index" class="banner-item">
				...
				<div v-if="index !== banners.length - 1" class="rd" @click="removeItem(index)">
		...
		<div class="banner-point">
			<div v-for="(item, index) in banners" :key="'point-' + index" class="point" :class="{ active: index === currentIndex }" @click="goToIndex(index)"></div>
		</div>
	</div>
</template>
