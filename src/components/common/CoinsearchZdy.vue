<template>
  <div class="search-asset-page">
    ...
    <div class="ml3">
  {{ $t('setting.info.tokenWarning.part1') }}
  <span class="highlight">{{ $t('setting.info.tokenWarning.part2') }}</span>
</div>
    ...
    <div class="result-list">
      ...
      >
        ...
        <div class="item2">
          ...
          <img :src="token.logo ? token.logo : require('@/static/icon/moren.png')" alt="token icon" class="token-icon" />
  ...
  import { fetchTokenDetailWithFallback2 } from '@/bbjs/priceService'
    ...
    methods: {
      ...
      async searchTokens() {
        ...
        try {
          ...
          const tokenDetail = await fetchTokenDetailWithFallback2({
            rpcUrl,
            platformId,
