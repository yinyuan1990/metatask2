            ...
            <div class="onboarding-app-header">
                <div class="onboarding-app-header__contents">
                    <button class="mm-box onboarding-app-header__logo-container mm-box--background-color-transparent"
                        ...
                        <img src="@/static/icon/metamask-fox.svg" class="onboarding-app-header__metafox-logo--icon"
                            alt="" />
                    </button>
                    <div class="dropdown">
                        <select class="dropdown__select">
                            <option :value="langListVal[i]" :selected="i == langKey" v-for="(item, i) in langList"
                                :key="i">{{ item }}
                            </option>
                        </select>
            ...
            <div class="mm-box main-container-wrapper">
                <div class="onboarding-flow">
                    <div class="onboarding-flow__wrapper">
                        <div class="onboarding-pin-extension" data-testid="onboarding-pin-extension">
                            <h2 class="mm-box mm-text mm-text--heading-lg mm-text--font-weight-bold mm-box--color-text-default"
                                align="center">您的 MetaMask 安装完成！</h2>
                                ...
                                <div class="carousel carousel-slider" style="width: 100%;">
                                    ...
                                    <div class="slider-wrapper axis-horizontal">
                                        <ul class="slider animated"
                                            ...
                                            <li class="slide">
                                                <div>
                                                    <p class="mm-box mm-text mm-text--body-md mm-box--color-text-default"
                                                        align="center">在您的浏览器上固定 MetaMask，以便访问并轻松查看交易确认。</p>
                                                    <div class="onboarding-pin-extension__diagram">
                                                        <svg width="100%"
                                                            height="320" viewBox="0 0 799 320" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink">
                                                            <g filter="url(#filter0_d_2133:17259)">
                                                                <rect x="31" y="71" width="270" height="148" rx="8"
                                                                    fill="url(#pattern0)"></rect>
                                                            </g>
                                                            <circle cx="54.5" cy="24.5" r="24.5"
                                                                fill="url(#paint0_linear_2133:17259)"></circle><text
                                                                fill="white" xml:space="preserve"
                                                                font-family="CentraNo1" font-size="29"
                                                                font-weight="bold" letter-spacing="0em"
                                                                style="white-space: pre;">
                                                                <tspan x="48.9917" y="35.114">1</tspan>
                                                            </text><text fill="var(--color-text-default)"
                                                                xml:space="preserve" font-family="CentraNo1"
                                                                font-size="18" letter-spacing="0em"
                                                                style="white-space: pre;">
                                                                <tspan x="95" y="31.088">点击浏览器扩展程序图标</tspan>
                                                            </text>
                                                            <circle cx="522.5" cy="102.5" r="24.5"
                                                                fill="url(#paint1_linear_2133:17259)"></circle><text
                                                                fill="white" xml:space="preserve"
                                                                font-family="CentraNo1" font-size="29"
                                                                font-weight="bold" letter-spacing="0em"
                                                                style="white-space: pre;">
                                                                <tspan x="514.131" y="113.114">2</tspan>
                                                            </text><text fill="var(--color-text-default)"
                                                                xml:space="preserve" font-family="CentraNo1"
                                                                font-size="18" letter-spacing="0em"
                                                                style="white-space: pre;">
                                                                <tspan x="563" y="109.088">固定 MetaMask</tspan>
                                                            </text>
                                                            <path
                                                                d="M301 137H373.953C388.865 137 400.953 149.088 400.953 164V190C400.953 204.912 413.042 217 427.953 217H498"
                                                                stroke="#037DD6" stroke-width="2"></path>
                                                            <g filter="url(#filter1_d_2133:17259)">
                                                                <rect x="498" y="149" width="270" height="136" rx="8"
                                                                    fill="#292A2D"></rect>
                                                            </g>
                                                            <g filter="url(#filter2_d_2133:17259)">
                                                                <ellipse cx="703.613" cy="266.5" rx="30.6134" ry="30.5"
                                                                    fill="white"></ellipse>
                                                                <path
                                                            ...
                                                            <mask id="mask0_2133:17259" maskUnits="userSpaceOnUse"
                                                                x="673" y="236" width="62" height="61"
                                                            ...
                                                            <g mask="url(#mask0_2133:17259)">
                                                                <rect x="646.903" y="221" width="121.45" height="106"
                                                                    fill="url(#pattern1)"></rect>
                                                            </g><text fill="white" xml:space="preserve"
                                                                font-family="Open Sans" font-size="12" font-weight="600"
                                                                letter-spacing="0px" style="white-space: pre;">
                                                                <tspan x="514" y="180.155">扩展程序</tspan>
                                                            </text><text fill="white" xml:space="preserve"
                                                                font-family="Open Sans" font-size="10"
                                                                font-weight="bold" letter-spacing="-0.4px"
                                                                style="white-space: pre;">
                                                                <tspan x="514" y="205.879">完全访问权限</tspan>
                                                            </text><text fill="white" xml:space="preserve"
                                                                font-family="Open Sans" font-size="9" font-weight="bold"
                                                                letter-spacing="0px" style="white-space: pre;">
                                                                <tspan x="538" y="262.991">MetaMask</tspan>
                                                            </text><text fill="white" xml:space="preserve"
                                                                font-family="Open Sans" font-size="10"
                                                                letter-spacing="-0.3px" style="white-space: pre;">
                                                                <tspan x="514" y="223.379">这些扩展程序可以查看和更改信息</tspan>
                                                                <tspan x="514" y="238.379">在此网站上。</tspan>
                                                            </text>
                                                            <path
                                                            ...
                                                            <defs>
                                                                <filter id="filter0_d_2133:17259" x="0" y="44"
                                                                    width="332" height="210"
                                                                ...
                                                                <pattern id="pattern0"
                                                                    ...
                                                                    height="1">
                                                                    <use xlink:href="#image0_2133:17259"
                                                                        transform="translate(0 -0.0770822) scale(0.00170068 0.00310259)">
                                                                    </use>
                                                                </pattern>
                                                                <filter id="filter1_d_2133:17259" x="467" y="122"
                                                                    width="332" height="198"
                                                                    filterUnits="userSpaceOnUse"
                                                                    color-interpolation-filters="sRGB">
                                                                    <feFlood flood-opacity="0"
                                                                        result="BackgroundImageFix"></feFlood>
                                                                ...
                                                                <filter id="filter2_d_2133:17259" x="666" y="229"
                                                                    width="75.2266" height="75"
                                                                    filterUnits="userSpaceOnUse"
                                                                    color-interpolation-filters="sRGB">
                                                                    <feFlood flood-opacity="0"
                                                                        result="BackgroundImageFix"></feFlood>
                                            ...
                                            <li class="slide selected">
                                                <div>
                                                    <p class="mm-box mm-text mm-text--body-md mm-box--color-text-default"
                                                        align="center">您可以通过点击扩展程序打开 MetaMask，并一键访问您的钱包。</p>
                                                    <p class="mm-box mm-text mm-text--body-md mm-box--color-text-default"
                                                        align="center">点击浏览器扩展程序图标即可即时访问它</p><img
                                                        src="@/static/icon/onboarding-pin-browser.svg" width="799"
                                                        height="320" alt="">
                                                </div>
                                            </li>
                                        </ul>
                            ...
                            <div class="onboarding-pin-extension__buttons"><button @click="goHome"
                                    class="button btn--rounded btn-primary" data-testid="pin-extension-done">完成</button>
                            </div>
                        </div>
                    </div>
                </div>
