<template>
    <PageContainer title="显示私钥助记词">
        <div style="display: flex; flex-direction: column; row-gap: 8px;">
            <p class="mm-box mm-text mm-text--body-md mm-box--color-text-default"><span> <a
                        ...
                        target="_blank" rel="noopener noreferrer">{{ $t('secret.srp') }}</a> {{ $t('secret.accessDesc') }} <strong
                        class="mm-box mm-text mm-text--body-md-bold mm-box--color-text-default">对您的钱包和资金的完整访问权限。</strong>
                </span></p>
            <p class="mm-box mm-text mm-text--body-md mm-box--color-text-default"><span> MetaMask 是<a
                        class="mm-box mm-text mm-button-base mm-button-link mm-button-link--size-inherit mm-text--body-md-medium mm-box--padding-0 mm-box--padding-right-0 mm-box--padding-left-0 mm-box--display-inline-flex mm-box--justify-content-center mm-box--align-items-center mm-box--color-primary-default mm-box--background-color-transparent"
                        href="https://support.metamask.io/getting-started/metamask-is-a-self-custodial-wallet/"
                        target="_blank" rel="noopener noreferrer">非保管钱包</a>。这意味着，<span
                        class="mm-box mm-text mm-text--body-md-bold mm-box--color-text-default">您是自己的 SRP
                        的所有者</span>。 </span></p>
            <div class="mm-box mm-banner-base mm-banner-alert mm-banner-alert--severity-danger mm-box--padding-4 mm-box--padding-left-2 mm-box--display-flex mm-box--gap-2 mm-box--background-color-error-muted mm-box--rounded-sm"
                ...
                <div class="mm-box mm-box--min-width-0">
                    <p class="mm-box mm-text mm-text--body-sm mm-box--color-text-default"><span> 确保没有人在看您的屏幕。<strong
                                class="mm-box mm-text mm-text--body-md-bold mm-box--color-text-default">MetaMask
                                支持团队绝对不会要求提供此项这个。</strong> </span></p>
                </div>
            </div>
                ...
                <div class="mm-box tabs" defaultactivetabname="文本">
                    ...
                    <div v-if="activeTab === 'text'" class="mm-box tabs__content"><label
                        ...
                        <div
                            ...
                            <p class="mm-box mm-text notranslate mm-text--body-lg-medium mm-box--display-flex mm-box--justify-content-center mm-box--color-text-default"
        ...
        <Dialog v-if="showDialog" @onClose="onClose" :headerCustomStyle="{
            ...
            <template v-slot:header>
                <h4 class="mm-box mm-text mm-text--heading-sm mm-box--color-text-default">保护好您的 <span
                        style="padding: 0 4px;">助记词</span> 安全</h4>
            </template>
            <div class="mm-box mm-box--margin-top-4 mm-box--margin-bottom-6 mm-box--display-flex mm-box--gap-2 mm-box--flex-direction-column"
                style="margin: 0;">
                <p class="mm-box mm-text mm-text--body-md mm-box--color-text-default"><span> 您的私钥助记词<span
                            style="padding: 0 4px;">提供</span> <span
                            class="mm-box mm-text mm-text--body-md-bold mm-box--color-text-default">对您的钱包和资金的完整访问权限。</span>
                    </span>
                </p>
...
export default {
    ...
    data() {
        return {
            ...
            activeTab: 'text',
            qrcodeDataUrl: '',
            word: accountManager.getCurrentAccount().mnemonic,
        }
    },
    computed: {
        strokeOffset() {
