...
#app {
  ...
  color: #2c3e50;
  font-family: Poppins-Regular, PingFang SC, miui, Hiragino Sans GB,
...
body {
  ...
  font-family: Poppins-Regular, Haas Grot Text R, PingFangSC-Regular,
    Helvetica Neue, Microsoft YaHei, \5fae\8f6f\96c5\9ed1, Arial, sans-serif;
}
...
:root {
  ...
  --van-collapse-item-content-background-color: var(
...
:root {
  ...
  --van-switch-node-box-shadow: 0 0.06rem 0.02rem 0 rgba(0, 0, 0, 0.05),
    0 0.04rem 0.04rem 0 rgba(0, 0, 0, 0.1),
    0 0.06rem 0.06rem 0 rgba(0, 0, 0, 0.05);
...
:root {
  ...
  --van-cell-group-inset-title-padding: var(--van-padding-md)
    var(--van-padding-md) var(--van-padding-xs) var(--van-padding-xl);
}
...
:root {
  ...
  --van-line-height-md: 0.4rem;
  --van-line-height-lg: 0.44rem;
  --van-base-font-family: "Poppins-Regular", "PingFang SC", "miui",
    "Hiragino Sans GB", "Microsoft Yahei", sans-serif;
  --van-price-integer-font-family: Avenir-Heavy, PingFang SC, Helvetica Neue,
    Arial, sans-serif;
  --van-animation-duration-base: 0.3s;
