 ...
 * @LastEditors: lh
 * @LastEditTime: 2023-01-06 12:24:28
 * @Description: 
-->
<template>
	<div>
...
.copybox_icon {
	mask-image: url('@/static/icon/copy.svg');
	color: var(--color-primary-default);
}

/* 隐藏Chrome和Safari的密码保存提示 */
...
.exprotboxs.news .exprotboxs_icon {
	mask-image: url('@/static/icon/refresh.svg');
}
...
.skypeGroups_close {
	...
	-webkit-mask-position: center;
	--size: 16px;
	mask-image: url('@/static/icon/close.svg');
	color: #121314;
	position: absolute;
	right: 16px;
	top: 16px;
}
.skypeGroups_close.back {
	left: 16px;
	right: unset;
...
/* @font-face {
  ...
  src: url(/assets/index.6ae76e9a.eot);
  src: url(/assets/index.6ae76e9a.eot) format("embedded-opentype"),
    url(/assets/index.efb99a75.woff2) format("woff2"),
    url(/assets/index.eeb0834f.woff) format("woff"),
    url(/assets/index.12e8f76d.ttf) format("truetype"),
    url(/assets/index.7b15a862.svg) format("svg");
  font-weight: 400;
  font-style: normal
} */
...
body {
	...
	font-family: Poppins-Regular, Haas Grot Text R, PingFangSC-Regular, Helvetica Neue, Microsoft YaHei, \5fae\8f6f\96c5\9ed1, Arial, sans-serif;
}
...
/* @font-face {
  ...
  src: url(./static/icon/iconfont.eot?t=1669089619118);
  src: url(./static/icon/iconfont.eot?t=1669089619118#iefix) format("embedded-opentype"),
    url(./static/icon/iconfont.woff2?t=1669089619118) format("woff2"),
    url(./static/icon/iconfont.woff?t=1669089619118) format("woff"),
    url(./static/icon/iconfont.ttf?t=1669089619118) format("truetype"),
    url(./static/icon/iconfont.svg?t=1669089619118#iconfont) format("svg")
}
...
.icon-token-container .icon-token {
	width: 0.5rem;
	height: 0.5rem;
	border-radius: 50%;
}

.icon-token-container .icon-network {
	font-size: 0.28rem;
	position: absolute;
	bottom: 0;
	right: -0.06rem;
...
:root {
	...
	--van-padding-base: 0.08rem;
	--van-padding-xs: 0.16rem;
	--van-padding-sm: 0.24rem;
	--van-padding-md: 0.32rem;
	--van-padding-lg: 0.48rem;
	--van-padding-xl: 0.64rem;
	--van-font-size-xs: 0.2rem;
	--van-font-size-sm: 0.24rem;
	--van-font-size-md: 0.28rem;
	--van-font-size-lg: 0.32rem;
	--van-font-weight-bold: 500;
	--van-line-height-xs: 0.28rem;
	--van-line-height-sm: 0.36rem;
	--van-line-height-md: 0.4rem;
	--van-line-height-lg: 0.44rem;
	...
	--van-border-width-base: 0.02rem;
	--van-border-radius-sm: 0.04rem;
	--van-border-radius-md: 0.08rem;
	--van-border-radius-lg: 0.16rem;
	--van-border-radius-max: 19.98rem;
}
...
:root {
	--van-badge-size: 0.32rem;
	--van-badge-color: var(--van-white);
	--van-badge-padding: 0 0.06rem;
...
@font-face {
	...
	src: url(data:font/woff2;charset=utf-8;base64,)
			format('woff2'),
		url(//at.alicdn.com/t/font_2553510_iv4v8nulyz.woff?t=1649083952952) format('woff'), url(//at.alicdn.com/t/font_2553510_iv4v8nulyz.ttf?t=1649083952952) format('truetype');
}
...
:root {
	...
	--van-notice-bar-line-height: 0.48rem;
	--van-notice-bar-background-color: var(--van-orange-light);
	--van-notice-bar-icon-size: 0.32rem;
	--van-notice-bar-icon-min-width: 0.48rem;
}
...
:root {
	...
	--van-image-loading-icon-size: 0.64rem;
	--van-image-loading-icon-color: var(--van-gray-4);
	--van-image-error-icon-size: 0.64rem;
...
:root {
	...
	--van-tag-border-radius: 0.04rem;
	--van-tag-line-height: 0.32rem;
	--van-tag-medium-padding: 0.04rem 0.12rem;
...
:root {
	...
	--van-card-thumb-size: 1.76rem;
	--van-card-thumb-border-radius: var(--van-border-radius-lg);
	--van-card-title-line-height: 0.32rem;
...
.van-cell:after {
	...
	border-bottom: 0.02rem solid var(--van-cell-border-color);
...
:root {
	...
	--van-contact-card-add-icon-size: 0.8rem;
...
.van-collapse-item--border:after {
	...
	right: var(--van-padding-md);
	left: var(--van-padding-md);
	border-top: 0.02rem solid var(--van-border-color);
	transform: scaleY(0.5);
}
...
:root {
	...
	--van-field-icon-size: 0.32rem;
	--van-field-clear-icon-size: 0.32rem;
	...
	--van-field-error-message-font-size: 0.24rem;
	--van-field-text-area-min-height: 1.2rem;
	--van-field-word-limit-color: var(--van-gray-7);
	--van-field-word-limit-font-size: var(--van-font-size-sm);
	--van-field-word-limit-line-height: 0.32rem;
...
:root {
	--van-search-padding: 0.2rem var(--van-padding-sm);
	--van-search-background-color: var(--van-background-color-light);
	--van-search-content-background-color: var(--van-gray-1);
	--van-search-input-height: 0.68rem;
	--van-search-label-padding: 0 0.1rem;
...
.van-search__field {
	flex: 1;
	padding: 0.1rem var(--van-padding-xs) 0.1rem 0;
	background-color: transparent;
}
...
:root {
	...
	--van-loading-spinner-size: 0.6rem;
...
:root {
	...
	--van-number-keyboard-key-height: 0.96rem;
	--van-number-keyboard-key-font-size: 0.56rem;
	...
	--van-number-keyboard-title-height: 0.68rem;
...
:root {
	...
	--van-list-text-line-height: 1rem;
	--van-list-loading-icon-size: 0.32rem;
}
...
:root {
	...
	--van-switch-node-box-shadow: 0 0.06rem 0.02rem 0 rgba(0, 0, 0, 0.05), 0 0.04rem 0.04rem 0 rgba(0, 0, 0, 0.1), 0 0.06rem 0.06rem 0 rgba(0, 0, 0, 0.05);
...
:root {
	...
	--van-picker-toolbar-height: 0.88rem;
...
:root {
	...
	--van-button-loading-icon-size: 0.4rem;
}
...
:root {
	...
	--van-submit-bar-tip-icon-size: 0.24rem;
	--van-submit-bar-button-height: 0.8rem;
...
:root {
	--van-action-bar-button-height: 0.8rem;
...
:root {
	...
	--van-popup-round-border-radius: 0.32rem;
	--van-popup-close-icon-size: 0.44rem;
	--van-popup-close-icon-color: var(--van-gray-5);
	--van-popup-close-icon-margin: 0.32rem;
...
:root {
	...
	--van-share-sheet-description-line-height: 0.32rem;
	--van-share-sheet-icon-size: 0.96rem;
	...
	--van-share-sheet-cancel-button-height: 0.96rem;
...
:root {
	...
	--van-dialog-button-height: 0.96rem;
	--van-dialog-round-button-height: 0.72rem;
...
.van-dialog__message {
	...
	padding: 0.52rem var(--van-dialog-message-padding);
	overflow-y: auto;
...
:root {
	...
	--van-toast-icon-size: 0.72rem;
	--van-toast-text-min-width: 1.92rem;
	--van-toast-text-padding: var(--van-padding-xs) var(--van-padding-sm);
	--van-toast-default-padding: var(--van-padding-md);
	--van-toast-default-width: 1.76rem;
	--van-toast-default-min-height: 1.76rem;
...
:root {
	...
	--van-calendar-header-box-shadow: 0 0.04rem 0.2rem rgba(125, 126, 128, 0.16);
	--van-calendar-header-title-height: 0.88rem;
	--van-calendar-header-title-font-size: var(--van-font-size-lg);
	--van-calendar-header-subtitle-font-size: var(--van-font-size-md);
	--van-calendar-weekdays-height: 0.6rem;
	...
	--van-calendar-month-mark-font-size: 3.2rem;
	--van-calendar-day-height: 1.28rem;
	--van-calendar-day-font-size: var(--van-font-size-lg);
	--van-calendar-day-margin-bottom: 0.08rem;
	...
	--van-calendar-selected-day-size: 1.08rem;
	...
	--van-calendar-confirm-button-height: 0.72rem;
	--van-calendar-confirm-button-margin: 0.14rem 0;
}
...
:root {
	...
	--van-action-sheet-header-height: 0.96rem;
	...
	--van-action-sheet-close-icon-size: 0.44rem;
	...
	--van-action-sheet-loading-icon-size: 0.44rem;
}
...
.van-action-sheet__cancel {
	display: block;
	width: 100%;
	padding: 0.28rem var(--van-padding-md);
...
.van-action-sheet__description {
	position: relative;
	flex-shrink: 0;
	padding: 0.4rem var(--van-padding-md);
...
.van-action-sheet__description:after {
	...
	bottom: 0;
	left: var(--van-padding-md);
	border-bottom: 0.02rem solid var(--van-border-color);
	transform: scaleY(0.5);
}
...
:root {
	...
	--van-coupon-content-height: 1.68rem;
	--van-coupon-content-padding: 0.28rem 0;
	...
	--van-coupon-box-shadow: 0 0 0.08rem rgba(0, 0, 0, 0.1);
	--van-coupon-head-width: 1.92rem;
	--van-coupon-amount-color: var(--van-danger-color);
	--van-coupon-amount-font-size: 0.6rem;
...
.van-coupon__description {
	...
	font-size: var(--van-font-size-sm);
	border-top: 0.02rem dashed var(--van-coupon-description-border-color);
}
...
.van-coupon--disabled .van-coupon-item__content {
	height: calc(var(--van-coupon-content-height) - 0.2rem);
}
...
.van-radio__icon .van-icon {
	...
	line-height: 1.25;
	text-align: center;
	border: 0.02rem solid var(--van-radio-border-color);
...
:root {
	--van-contact-list-edit-icon-size: 0.32rem;
...
:root {
	--van-address-list-padding: var(--van-padding-sm) var(--van-padding-sm) 1.6rem;
...
:root {
	--van-swipe-indicator-size: 0.12rem;
...
:root {
	...
	--van-image-preview-index-text-shadow: 0 0.02rem 0.02rem var(--van-gray-8);
	--van-image-preview-overlay-background-color: rgba(0, 0, 0, 0.9);
	--van-image-preview-close-icon-size: 0.44rem;
...
:root {
	--van-uploader-size: 1.6rem;
	--van-uploader-icon-size: 0.48rem;
...
:root {
	...
	--van-tabs-line-height: 0.88rem;
	--van-tabs-card-height: 0.6rem;
	--van-tabs-nav-background-color: var(--van-background-color-light);
	--van-tabs-bottom-bar-width: 0.8rem;
	--van-tabs-bottom-bar-height: 0.06rem;
...
:root {
	--van-cascader-header-height: 0.96rem;
	--van-cascader-header-padding: 0 var(--van-padding-md);
	--van-cascader-title-font-size: var(--van-font-size-lg);
	--van-cascader-title-line-height: 0.4rem;
	--van-cascader-close-icon-size: 0.44rem;
	--van-cascader-close-icon-color: var(--van-gray-5);
	--van-cascader-selected-icon-size: 0.36rem;
	--van-cascader-tabs-height: 0.96rem;
	--van-cascader-active-color: var(--van-danger-color);
	--van-cascader-options-height: 7.68rem;
...
.van-cascader__option {
	...
	align-items: center;
	justify-content: space-between;
	padding: 0.2rem var(--van-padding-md);
	font-size: var(--van-font-size-md);
	line-height: var(--van-line-height-md);
	cursor: pointer;
}
...
:root {
	...
	--van-cell-group-title-line-height: 0.32rem;
...
:root {
	...
	--van-empty-image-size: 3.2rem;
	--van-empty-description-margin-top: var(--van-padding-md);
	--van-empty-description-padding: 0 1.2rem;
	...
	--van-empty-bottom-margin-top: 0.48rem;
}
...
:root {
	...
	--van-coupon-list-field-padding: 0.1rem 0 0.1rem var(--van-padding-md);
	--van-coupon-list-exchange-button-height: 0.64rem;
	--van-coupon-list-close-button-height: 0.8rem;
...
.van-coupon-list__exchange {
	...
	font-size: var(--van-font-size-lg);
	line-height: calc(var(--van-coupon-list-exchange-button-height) - 0.04rem);
	border: 0;
}

.van-coupon-list .van-tabs__wrap {
	box-shadow: 0 0.12rem 0.24rem -0.24rem var(--van-gray-6);
}
...
.van-coupon-list__bottom {
	...
	box-sizing: border-box;
	width: 100%;
	padding: 0.1rem var(--van-padding-md);
	font-weight: var(--van-font-weight-bold);
	background-color: var(--van-background-color-light);
}
...
:root {
	...
	--van-divider-line-height: 0.48rem;
...
:root {
	--van-dropdown-menu-height: 0.96rem;
	--van-dropdown-menu-background-color: var(--van-background-color-light);
	--van-dropdown-menu-box-shadow: 0 0.04rem 0.24rem rgba(100, 101, 102, 0.12);
	--van-dropdown-menu-title-font-size: 0.3rem;
...
:root {
	...
	--van-grid-item-icon-size: 0.56rem;
...
:root {
	...
	--van-index-anchor-line-height: 0.64rem;
...
:root {
	--van-pagination-height: 0.8rem;
	--van-pagination-font-size: var(--van-font-size-md);
	--van-pagination-item-width: 0.72rem;
...
:root {
	--van-password-input-height: 1rem;
	--van-password-input-margin: 0 var(--van-padding-md);
	--van-password-input-font-size: 0.4rem;
	--van-password-input-border-radius: 0.12rem;
	...
	--van-password-input-dot-size: 0.2rem;
	...
	--van-password-input-cursor-width: 0.02rem;
...
:root {
	...
	--van-progress-pivot-padding: 0 0.1rem;
...
:root {
	...
	--van-sidebar-padding: 0.4rem var(--van-padding-sm);
	...
	--van-sidebar-selected-border-width: 0.08rem;
	--van-sidebar-selected-border-height: 0.32rem;
...
:root {
	...
	--van-tree-select-nav-item-padding: 0.28rem var(--van-padding-sm);
	--van-tree-select-item-height: 0.96rem;
	--van-tree-select-item-active-color: var(--van-danger-color);
	--van-tree-select-item-disabled-color: var(--van-gray-5);
	--van-tree-select-item-selected-size: 0.32rem;
}
...
.van-tree-select__item {
	position: relative;
	padding: 0 0.64rem 0 var(--van-padding-md);
	font-weight: var(--van-font-weight-bold);
...
:root {
	--van-skeleton-row-height: 0.32rem;
	...
	--van-skeleton-avatar-size: 0.64rem;
...
:root {
	...
	--van-slider-bar-height: 0.04rem;
	--van-slider-button-width: 0.48rem;
	--van-slider-button-height: 0.48rem;
	--van-slider-button-border-radius: 50%;
	--van-slider-button-background-color: var(--van-white);
	--van-slider-button-box-shadow: 0 0.02rem 0.04rem rgba(0, 0, 0, 0.5);
}
...
:root {
	...
	--van-step-icon-size: 0.24rem;
	--van-step-circle-size: 0.1rem;
...
:root {
	...
	--van-stepper-input-width: 0.64rem;
	--van-stepper-input-height: 0.56rem;
...
.van-stepper--round .van-stepper__minus {
	...
	background-color: var(--van-background-color-light);
	border: 0.02rem solid var(--van-stepper-button-round-theme-color);
}
...
:root {
	...
	--van-tabbar-item-icon-size: 0.44rem;
...
:root {
	...
	--van-orange-light: #fffbe8;
	--van-green: #07c160;
	--van-color-primary: #558bed;
	--van-gradient-red: linear-gradient(to right, #ff6034, #ee0a24);
	--van-gradient-orange: linear-gradient(to right, #ffd01e, #ff8917);
	--van-primary-color: var(--van-color-primary);
	--van-success-color: var(--van-green);
	--van-danger-color: var(--van-red);
	--van-warning-color: var(--van-orange);
	--van-active-color: var(--van-gray-2);
	...
	--van-line-height-md: 0.4rem;
	--van-line-height-lg: 0.44rem;
	--van-base-font-family: 'Poppins-Regular', 'PingFang SC', 'miui', 'Hiragino Sans GB', 'Microsoft Yahei', sans-serif;
	--van-price-integer-font-family: Avenir-Heavy, PingFang SC, Helvetica Neue, Arial, sans-serif;
	--van-animation-duration-base: 0.3s;
	--van-animation-duration-fast: 0.2s;
	--van-animation-timing-function-enter: ease-out;
	...
	--van-border-radius-lg: 0.16rem;
	--van-border-radius-max: 19.98rem;
	--van-tabbar-background-color: #1d223d;
	--van-tabbar-item-active-background-color: #1d223d;
	--van-tabbar-height: 1.2rem;
	--van-action-sheet-cancel-text-color: #323233;
	--van-empty-description-padding: 0;
	--van-empty-image-size: 1.8rem;
	--van-empty-description-color: #878fbc;
	--van-field-input-text-color: var(--van-gray-8);
	--van-tab-active-text-color: var(--van-color-primary);
	--van-button-plain-background-color: transparent;
	--van-nav-bar-height: 1rem;
	--van-nav-bar-background-color: #2c3254;
	--van-nav-bar-icon-color: #878fbc;
	--van-nav-bar-text-color: #878fbc;
	--van-nav-bar-title-text-color: #878fbc;
	--van-nav-bar-arrow-size: 0.36rem;
	--van-empty-image-size: 2.3rem;
	--van-empty-description-margin-top: var(--van-padding-sm);
}
